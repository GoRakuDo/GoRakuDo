...
Mengeklik salah satu tombol ini akan mengarahkan kamu ke situs masing-masing, dan mencari target kosakata secara otomatis.
...
Jika kamu ingin menambahkan atau menghapus situs apa pun yang didukung, buka bagian `<!-- External Links -->` pada Template Belakang (Back Templatee):
