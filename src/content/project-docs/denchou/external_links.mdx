...
Mengeklik salah satu tombol ini akan mengarahkan kamu ke situs masing-masing, dan mencari target kosakata secara otomatis. Situs yang Didukung:
*   [JPDB](https://jpdb.io/)
...
Untuk menghilangkan Tautan Eksternal sepenuhnya, buka bagian `/* Component Visibility */` pada CSS:
...
Jika kamu ingin menambahkan atau menghapus situs, buka bagian `<!-- External Links -->` pada Template Belakang (Back Templatee):
...
<a data-details="jpdb.io" href="https://jpdb.io/search?q={{text:word}}">
 ...
 Template untuk menambahkan situs baru:
 ...
 > **Lokasi Folder Ikon**
 >
 > Ikon situs barumu harus diletakkan di dalam folder `%appdata%\Anki2\[NamaPenggunaKamu]\collection.media`. Jangan lupa untuk menambahkan garis bawah (`_`) di awal nama file, contohnya `_icon_example_dark.png`.
